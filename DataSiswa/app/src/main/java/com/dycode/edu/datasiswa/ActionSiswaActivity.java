...
public class ActionSiswaActivity extends AppCompatActivity {
    ...
    EditText editValueName;
    @BindView(R.id.edit_value_address)
    EditText editValueAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editValueName.setText(siswaModel.getName());
        editValueAddress.setText(siswaModel.getAddress());
    ...
    public void onBtnUpdateClicked(){
        siswaModel.setName(editValueName.getText().toString());
        siswaModel.setAddress(editValueAddress.getText().toString());
